...
{
    public class MultibuyOfferOptionsTests
    {
        #region Tests
        ...
        {
            // Assert
            Assert.IsTrue(typeof(Offer).IsAssignableFrom(typeof(MultibuyOfferOptions)));
        }
        ...
        public void Is_InitialisedCorrectly()
        {
            ...
            // Assert
            Assert.AreEqual(OfferType.Multibuy, multibuyOfferOptions.OfferType);
        }
